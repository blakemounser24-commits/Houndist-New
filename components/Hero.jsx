...
export default function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative flex h-[88vh] min-h-[600px] max-h-[880px] items-center overflow-hidden bg-forest"
    >
      {/* Video background */}
      <video
      ...
      <div className="container-luxe relative z-10 px-6 pt-8 sm:px-10 lg:px-16">
